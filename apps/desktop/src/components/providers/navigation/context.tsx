 ...
 * [OUTPUT]: Provides composition-owned Account, Providers, Updates and Usage settings actions — Usage optionally landing on one Agent's tab — without inventing routes or owning chat state.
...
export type SettingsNavigation = { openUsage(trigger: HTMLElement | null, agent?: AgentBackendId): void; openAgents(): void; openUpdates(): void; openAccount(): void };
