 ...
 * [OUTPUT]: Provides studioConsentRequest, StudioConsentPermissions, and useStudioConsent — the one disclosure and the one allow/decline state machine shared by the Studio gate and the pending-generation card
 * [POS]: The consent leaf of components/apps; both consent surfaces read this instead of each writing their own half of the requested set
 */
...
export function StudioConsentPermissions({
  ...
  return (
    <ul className="mt-3 space-y-2 rounded-md border bg-muted/40 p-3 text-xs">
