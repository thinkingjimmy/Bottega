...
/**
 * [INPUT]: Depends on Base App lifecycle/generation, BaseWorkbench/AppGuiSurface, trusted file-export IPC, use-chat, routing, and window surface capsule checkpoints
...
function StudioAccessGate({ record }: { record: AppRecord }) {
...
function AuthorizedBaseAppDetail({ record }: { record: AppRecord }) {
  const { t } = useAppTranslation();
