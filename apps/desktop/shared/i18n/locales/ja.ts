...
import { systemDockJa } from "./system-dock/ja";
...
chat: "チャット",
moveFolder: "フォルダを移動",
moveFolderTitle: "Bottega フォルダを移動しますか？",
moveFolderBody: "会話、Project、Base、App、Skills もそのまま一緒に移動します。",
moveFolderFrom: "移動元",
moveFolderTo: "移動先",
moveFolderRestart: "Bottega が再起動し、開く前にフォルダを移動します。別のディスクへ移動する場合はまずすべてをコピーするため時間がかかることがあり、その後、元のフォルダはゴミ箱に移動します。",
moveFolderConfirm: "移動して再起動",
dangerZone: "危険な操作",
eraseAll: "このコンピュータのすべてのデータを消去",
eraseAllDescription: "このコンピュータ上の会話、設定、サインイン状態を削除し、Bottega を最初からやり直します。",
eraseAllButton: "データを消去",
eraseAllTitle: "このコンピュータのすべてのデータを消去しますか？",
eraseAllBody: "このコンピュータ上の会話、設定、鍵、サインイン状態が削除され、Bottega は初期設定から再起動します。この操作は取り消せません。",
eraseAllTrashFolder: "Bottega フォルダもゴミ箱に移動する",
eraseAllCloud: "アカウントに同期済みのデータはクラウドに残ります。再度サインインして同期をオンにすると戻ってきます。",
eraseAllConfirm: "消去して再起動",
...
currentModelUnavailable: "{{model}}（現在利用不可）"
    ...
    native: {
      ...
      libraryChatsSetAside_one: "Bottega フォルダ内の {{count}} 件の会話を開けなかったため、フォルダの .trash に移動しました。30 日後に削除されます。",
      libraryChatsSetAside_other: "Bottega フォルダ内の {{count}} 件の会話を開けなかったため、フォルダの .trash に移動しました。30 日後に削除されます。",
      ...
      libraryMovingTitle: "Bottega フォルダを移動しています",
      libraryMovingProgress: "ファイルをコピーしています… {{completed}} / {{total}}",
      libraryMoveSourceLeft: "Bottega フォルダは移動しましたが、{{path}} にある元のフォルダをゴミ箱に移動できませんでした。手動で削除できます。",
      libraryMoveDeferred: "完了していない処理があったため、Bottega フォルダは移動されませんでした。設定 › 一般 からもう一度お試しください。",
      libraryMoveFailed: "Bottega はフォルダの移動を完了できませんでした。現在は {{path}} にあります。",
      libraryMovePick: "Bottega フォルダの移動先を選択",
      libraryMovePickButton: "ここに移動",
      libraryMoveMissing: "Bottega フォルダがまだ設定されていません。",
      maintenanceBusy: "実行中のタスクが終わってから、もう一度お試しください。",
      libraryMove: {
        samePlace: "Bottega フォルダはすでにその場所にあります。",
        inside: "Bottega フォルダの外にある場所を選んでください。",
        exists: "その場所には同じ名前の項目がすでにあります。別の場所を選んでください。",
        unwritable: "Bottega はその場所に書き込めません。別の場所を選んでください。",
        projectOverlap: "その場所は Project フォルダと重なっています。Project の外にある場所を選んでください。",
      },
