...
export const onboardingZhCN: typeof onboardingEn = {
  ...
  description: { "chat-home": "选择已有的 Bottega 文件夹可恢复其中的内容，也可以选择空文件夹开始。账号设置、密钥和设备授权留在这台电脑上。", agent: "安装至少一个 Agent 即可继续。", extras: "导入可复用的 Skills，并设置长期记忆。两项均为可选，之后可随时在 Settings 中更改。" },
