...
export const memoryEn = {
  ...
  /* ── 安装优先的初次设置：装好并配好之前，这一页只有这三步 ────────
     ...
     那是把「还没设置」画成了「坏了」。 */
  setup: {
    recommended: "Recommended", chooseTitle: "Choose a memory engine", chooseDescription: "It installs into its own locked Python environment on this Mac. You can switch engines later.",
    installingTitle: "Installing {{provider}}", installedTitle: "{{provider}} is installed", installFailedTitle: "{{provider}} didn’t finish installing",
    installingDescription: "This runs once. Afterwards the service starts at login and restarts itself if it crashes.", background: "Continue in Background", backgroundNote: "Installation keeps going in the background — Settings › Memory shows where it’s at, and you can connect a model there when it’s done.",
    connectTitle: "Connect a model", connectDescription: "An OpenAI-compatible model reads the messages you write and extracts what’s worth remembering. The key stays on this Mac.", connectSubmit: "Start Service",
    draftKept: "Closing keeps this draft until it applies successfully.",
    row: {
      notSetUp: "Not set up",
      installing: "Installing",
      installed: "Installed",
      failed: "Install failed",
      description: "Remembers what matters from past conversations and brings it back when it’s relevant. Runs a small service on this Mac.",
      installingDescription: "Installing {{provider}} — keeps going in the background. You can finish setting it up later.",
      connectDescription: "{{provider}} {{version}} is installed. Connect a model to start remembering.",
      failedDescription: "{{provider}} didn’t finish installing. Set it up again to retry.",
      setUp: "Set Up…",
    ...
    notes: {
      ...
      localTerm: "Stays on this Mac",
      localDetail: "The memory inventory never leaves this computer. Runtime and data folders are kept separate.",
      modelTerm: "Needs a model to extract memories",
      modelDetail: "Only the messages you write are sent to the OpenAI-compatible model you connect — nothing else.",
      removeTerm: "Remove any time",
      removeDetail: "Turning memory off pauses recall; removing it deletes the service and its data. Chat keeps working either way.",
    },
  },
  page: {
