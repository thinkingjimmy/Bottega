 ...
 * [OUTPUT]: Provides five-language copy for required onboarding gates, state-aware Agent setup guidance, optional Skills/Memory setup, nonblocking Skills scan recovery, and the Skills import notice title/description
...
export const onboardingEn = {
  ...
  blurb: { "chat-home": "Pick a folder on this Mac", agent: "Set up a local Agent", extras: "Skills and memory, now or later" },
  heading: { "chat-home": "Where should {{product}} keep your files?", agent: "Verify a local Agent", extras: "Get more from {{product}}" },
  blocked: { agent: "Set up an Agent to continue", checkingAgent: "Checking Agent availability…" },
...
export const onboardingZhCN: OnboardingCatalog = {
  ...
  blurb: { "chat-home": "在本机选一个目录", agent: "配置本机 Agent", extras: "Skills 与记忆，随时可设置" },
  heading: { "chat-home": "{{product}} 的文件放在哪里？", agent: "验证本机 Agent", extras: "发挥 {{product}} 的更多能力" },
  blocked: { agent: "配置好一个 Agent 即可继续", checkingAgent: "正在检查 Agent 是否可用…" },
...
export const onboardingJa: OnboardingCatalog = {
  ...
  blurb: { "chat-home": "この Mac のフォルダーを選ぶ", agent: "ローカル Agent を設定", extras: "Skills とメモリーは今でも後でも" },
  heading: { "chat-home": "{{product}} のファイルはどこに置きますか？", agent: "ローカル Agent を検証", extras: "{{product}} をさらに活用" },
  blocked: { agent: "Agent を 1 つ設定すると次へ進めます", checkingAgent: "Agent が利用可能か確認中…" },
...
export const onboardingFr: OnboardingCatalog = {
  ...
  blurb: { "chat-home": "Choisissez un dossier sur ce Mac", agent: "Configurez un Agent local", extras: "Skills et mémoire, maintenant ou plus tard" },
  ...
  blocked: { agent: "Configurez un Agent pour continuer", checkingAgent: "Vérification de la disponibilité des Agents…" },
...
export const onboardingEs: OnboardingCatalog = {
  ...
  blurb: { "chat-home": "Elige una carpeta en este Mac", agent: "Configura un Agent local", extras: "Skills y memoria, ahora o más adelante" },
  ...
  blocked: { agent: "Configura un Agent para continuar", checkingAgent: "Comprobando la disponibilidad de los Agents…" },
