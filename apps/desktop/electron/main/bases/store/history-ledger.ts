/**
 * [INPUT]: Depends on shared Base row and historical schemas/budgets; receives immutable before/after rows and commitLocked-generated entries
 * [OUTPUT]: Provides deterministic row-diff entry construction plus empty/parse/append/query operations; empty entries are not credited, and the oldest entries are discarded by count and UTF-8 byte budgets
...
export function createHistoryEntry(
  before: readonly BaseRow[],
  after: readonly BaseRow[],
  at: number,
  actor: import("../../../../shared/bases/history-ledger-schema").BaseHistoryActor,
  operation: string
...
/** Pure metadata commits have no row delta and therefore return null. */
