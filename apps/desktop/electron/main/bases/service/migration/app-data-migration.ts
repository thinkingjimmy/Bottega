/**
 * [INPUT]: Depends on shared App migration contracts, Base validation and column budgets, and main status errors.
 * [OUTPUT]: Provides the pure applyAppBaseDataMigration transform, preserving user values and returning no change on exact replay.
 * [POS]: App data migration leaf beneath the ordinary Base row mutation service; it owns no storage or preset-specific behavior.
 */
