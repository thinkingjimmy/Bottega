/**
 * [INPUT]: Depends on the existing shell, CLI version and the ACP probe per-request/total handshake budgets.
...
// Runtime 40s + auth queue 10s + ACP probe total cap 30s + cleanup margin 5s.
export const FULL_CHECK_MS = 85_000;
