...
Bottega v0.1.1 is available on the [Releases page](https://github.com/thinkingjimmy/Bottega/releases): a macOS arm64 DMG and ZIP, a Windows x64 installer, and a Linux x64 AppImage.
