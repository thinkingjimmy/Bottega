 ...
 * [POS]: Shared Base semantic kernel; The shared aggregation kernel; row membership follows the view projection while cell evaluation follows the full snapshot context
 */
