 ...
 * [POS]: Shared Base semantic kernel; Shared Base read-projection kernel; backs sorting, filtering, grouping, aggregating, and exporting, consumed by both the Agent tools and all six Base views
 */
...
import type {
  ...
  BaseColumn,
  BaseSelectOption,
} from "../model/base-values";
import { baseCellText, DELETED_RELATION_PREFIX } from "../model/base-values";
