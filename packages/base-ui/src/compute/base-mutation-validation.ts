/**
 * [INPUT]: Depends on shared Base column/line/meta type, attachment/date/formula/relation label helpers and base-view-validation, plus the shared shared Base validation error constructor
