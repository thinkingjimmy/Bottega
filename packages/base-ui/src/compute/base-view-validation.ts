/**
 * [INPUT]: Depends on shared Base view/filter/column DTO, the aggregation matrix, the filter column walker, and the shared Base validation error constructor
...
import {
  ...
  type BaseFilter,
  type BaseView,
} from "../model/bases-ipc";
import type { ChartItem } from "../model/base-view-config";
import { statusError } from "./validation-error";
