 ...
 * [POS]: Shared Base semantic kernel; The shared read-only formula kernel; main and renderer consume identical pure semantics without filesystem, DOM, or platform access
 */

import type { BaseCellValue, BaseColumn } from "../model/base-values";
