...
export function ColumnResizeHandle({
  ...
  return (
    <button
      ...
      aria-valuenow={width}
      className="absolute top-0 right-0 z-20 h-full w-2 translate-x-1/2 cursor-col-resize touch-none pointer-coarse:w-4 border-0 bg-transparent p-0 outline-none after:absolute after:top-0 after:bottom-0 after:left-1/2 after:w-px after:-translate-x-1/2 after:bg-transparent hover:after:bg-ring focus-visible:outline-none focus-visible:after:bg-ring data-[active=true]:after:bg-ring"
