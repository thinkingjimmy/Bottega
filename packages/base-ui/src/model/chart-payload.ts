 ...
 * [POS]: Shared Base semantic kernel; Single source of truth for the shared chart wire protocol; Base's live view and Chat's snapshot share one schema, so no host may define a second, private chart shape
 */
