 ...
 * [POS]: Shared Base semantic kernel; Shared Base view configuration boundary; imported one-way by bases-ipc to keep that IPC contract file from growing further
 */
