 ...
 * [OUTPUT]: Provides consistent owning-computer and explicit local-continuation/deletion copy in five languages.
...
const en = { deleted: "Deleted from sync. Local content is retained; save a copy from the recovery panel to continue.", computer: "Another computer", online: "Online", offline: "Offline", revoked: "Device revoked", runningOn: "Running on {device}",
  from: "From {device}", claiming: "Taking over…", preparing: "Preparing this conversation…", retryPreparation: "Retry preparation",
  draft: "Write a message", bindProject: "Bind a project folder", authorize: "Complete local authorization",
  ...
  localBusy: "Resolve the unfinished local reply before continuing.", draftFailed: "The draft could not be saved to this computer. Keep this page open and retry.", retryDraft: "Save draft again",
  ...
  remotePreparing: "Runs on {device} · Preparing", remoteReady: "Runs on {device} · Ready there",
...
const copies: Record<string, ExecutionCopy> = {
  en,
  zh: { deleted: "此对话已从云端删除，本机内容仍保留。可在保留分支中另存副本后继续。", computer: "其他电脑", online: "在线", offline: "离线", revoked: "设备已撤销", runningOn: "在 {device} 上运行", from: "来自 {device}", claiming: "正在接管…",
    preparing: "正在准备此对话…", retryPreparation: "重试准备", draft: "输入消息", bindProject: "绑定项目路径", authorize: "完成本机授权",
    ...
    localBusy: "请先处理本机尚未结束的回复。", draftFailed: "草稿尚未保存到本机，请保留此页面并重试。", retryDraft: "重新保存草稿",
    ...
    remotePreparing: "在 {device} 上运行 · 正在准备", remoteReady: "在 {device} 上运行 · 可在该电脑继续", appReadonly: "此 App 专用会话仅供阅读，不能在此接管。" },
  ja: { deleted: "同期から削除されました。ローカル内容は保持されています。復元パネルからコピーを保存して続行してください。", computer: "別のパソコン", online: "オンライン", offline: "オフライン", revoked: "デバイスが取り消されました", runningOn: "{device} で実行中", from: "{device} から", claiming: "引き継ぎ中…",
    preparing: "会話を準備中…", retryPreparation: "準備を再試行", draft: "メッセージを入力", bindProject: "プロジェクトのフォルダを設定", authorize: "ローカルの権限を設定",
    ...
    localBusy: "ローカルの未完了の応答を先に処理してください。", draftFailed: "下書きを保存できませんでした。このページを開いたまま再試行してください。", retryDraft: "下書きを再保存",
    ...
    remotePreparing: "{device} で実行 · 準備中", remoteReady: "{device} で実行 · 続行できます", appReadonly: "この App 専用の会話は閲覧専用です。ここでは引き継げません。" },
  fr: { deleted: "Supprimée de la synchronisation. Le contenu local est conservé. Enregistrez une copie depuis le panneau de récupération pour continuer.", computer: "Un autre ordinateur", online: "En ligne", offline: "Hors ligne", revoked: "Appareil révoqué", runningOn: "En cours sur {device}", from: "Depuis {device}", claiming: "Reprise en cours…",
    preparing: "Préparation de la conversation…", retryPreparation: "Réessayer la préparation", draft: "Écrire un message", bindProject: "Associer un dossier de projet", authorize: "Terminer l’autorisation locale",
    ...
    localBusy: "Traitez la réponse locale inachevée avant de continuer.", draftFailed: "Le brouillon n’a pas été enregistré. Gardez cette page ouverte et réessayez.", retryDraft: "Réenregistrer le brouillon",
    ...
    remotePreparing: "Exécution sur {device} · Préparation", remoteReady: "Exécution sur {device} · Prêt à continuer", appReadonly: "Cette conversation dédiée à l’App est en lecture seule ici. La reprise n’est pas disponible." },
  es: { deleted: "Eliminada de la sincronización. El contenido local se conserva. Guarda una copia desde el panel de recuperación para continuar.", computer: "Otro ordenador", online: "En línea", offline: "Sin conexión", revoked: "Dispositivo revocado", runningOn: "En ejecución en {device}", from: "Desde {device}", claiming: "Tomando el control…",
    preparing: "Preparando la conversación…", retryPreparation: "Reintentar preparación", draft: "Escribe un mensaje", bindProject: "Vincular carpeta del proyecto", authorize: "Completar autorización local",
    ...
    localBusy: "Resuelve primero la respuesta local pendiente.", draftFailed: "No se pudo guardar el borrador. Mantén esta página abierta y reinténtalo.", retryDraft: "Guardar el borrador de nuevo",
    ...
    remotePreparing: "En ejecución en {device} · Preparando", remoteReady: "En ejecución en {device} · Listo para continuar", appReadonly: "Esta conversación dedicada a la App es de solo lectura aquí. No se puede tomar el control." },
};
