...
export const chatInitialManifestSchema = z.object({ chatId: id, incarnationId: id, executionEpoch: rev, manifestId: id,
...
export const chatInitialPageSchema = z.object({ chatId: id, incarnationId: id, executionEpoch: rev, manifestId: id, operationId: id,
  offset: rev, bodyHashes: z.array(sha256Schema).min(1).max(16), payloadHash: sha256Schema,
}).strict();
