...
export const homeBindingSchema = z.object({ role: z.enum(["manifest", "page"]), incarnationId: id, snapshotId: id,
...
export const turnBindingSchema = z.object({ incarnationId: id, turnId: id, frameSequence: version,
