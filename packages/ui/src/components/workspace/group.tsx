/**
 * [INPUT]: Depends on react's ReactNode, lucide-react's ChevronDown and the shared Collapsible/Sidebar primitives.
 * [OUTPUT]: Controlled sidebar groups and action slots.
