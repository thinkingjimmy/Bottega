...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* 标题必须落在 DialogContent 之内。Dialog 本体是 Radix Root，不产生
            任何 DOM，把 header 挂在它下面、Content 之外，等于把这段 sr-only
            文字留在调用点原地（侧栏 DOM 里），而 Content 自己没有 DialogTitle
            后代——Radix 由此报缺标题告警，读屏也念不到这个浮层叫什么。 */}
