/**
 * [INPUT]: Depends on React, Radix Select, lucide icons, and cn
 * [OUTPUT]: Provides Select, SelectTrigger, SelectValue, SelectContent, and SelectItem; content owns inherited menu typography, popper/start defaults, and Electron no-drag
 * [POS]: The single-choice dropdown of components/ui shared by desktop settings and composer surfaces
 */
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex min-h-7 pointer-coarse:min-h-10 w-full cursor-pointer items-center gap-2 rounded-md px-2 py-1 outline-hidden select-none focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
