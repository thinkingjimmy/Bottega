 ...
 * [OUTPUT]: Japanese setup, immediate password validation, unlock and recovery messages.
...
export const ja: CloudEncryptionCopy = {
  ...
  setPassword: "同期パスワードを設定", setupDescription: "英字と数字を含む 8 文字以上のパスワードを設定し、安全に保管してください。Bottega は復元できません。",
  ...
  "sync-password-weak": "英字と数字をそれぞれ 1 文字以上含めてください。",
