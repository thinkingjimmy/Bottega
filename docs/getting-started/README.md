...
If you are upgrading from 0.1.0 or 0.1.1, download and install [0.1.4](https://github.com/thinkingjimmy/Bottega/releases/tag/v0.1.4) manually once. The older installed versions contain an updater bug; the fix takes effect after the new binary is installed. Windows continues to use manual installer downloads.
